    function game_over(typ_prehry){
                
                lopta.direction = "stop"
                var hlaska = typ_prehry+"\nSkóre:" + hrac.score
    ...
    function check_point(typ_prehry){
                ...
                if(lopta.life == 0){
                    game_over(typ_prehry)
                }else{
                    lopta.life -= 1
                }
    }
    function game_passed(){
...
function PrisekyVsLopta(priserka){
                ...
                if( 
                  ...
                  {
                    zvuk_monster.play()
                    check_point("Zničilo ťa monštrum.")
               }
        }
     ...
     for (i in ciarky) {
        var ciara = ciarky[i]
                   ...
                   ( ((priserka.y - 15) <= (ciara.end_y + ciara.zac_y)) && ((priserka.y + 15) >= ciara.zac_y )))
                {
                  ...
                  //  console.log(priserka + ' - '+ priserka.direction)
                }
            }
        }
